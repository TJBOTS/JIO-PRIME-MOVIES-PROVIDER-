...
#ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ:- একবার ভেরিফাই করুন আর পরবর্তী ১২ ঘণ্টা আনলিমিটেড এড ফ্রী ফাইল পান । ভেরিফাই করতে verify এ ক্লিক করুন ✓

যদি ডাইরেক্ট ফাইল চান তাহলে Remove Ads এ ক্লিক করুন । ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴅɪʀᴇᴄᴛ ғɪʟᴇꜱ ᴡɪᴛʜᴏᴜᴛ ᴀɴʏ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴꜱ ᴛʜᴇɴ ʙᴜʏ ʙᴏᴛ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ 😊

💶 sᴇɴᴅ /plan ᴛᴏ ʙᴜʏ sᴜʙsᴄʀɪᴘᴛɪᴏɴ</b>"""

    VERIFY_COMPLETE_TEXT = """<b>👋 ʜᴇʏ {},

ʏᴏᴜ ʜᴀᴠᴇ ᴄᴏᴍᴘʟᴇᴛᴇᴅ YOUR 12 HOURS ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ এখন থেকে আপনি পরবর্তী ১২ ঘন্টা এড ফ্রী এক্সপেরিয়েন্স পাবেন এখানেও মুভি রিকোয়েস্ট করতে পারবেন আবার ওই চ্যানেলে মুভিগুলোও এড ফ্রি পাবেন✓
